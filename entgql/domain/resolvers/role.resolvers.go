...
func (r *createRoleInputResolver) UserRoles(ctx context.Context, obj *ent.CreateRoleInput, data *ent.CreateManyAdminUserInput) error {
	panic(fmt.Errorf("not implemented: UserRoles - userRoles"))
}

// UserRoles is the resolver for the userRoles field.
func (r *updateRoleInputResolver) UserRoles(ctx context.Context, obj *ent.UpdateRoleInput, data *ent.UpdateManyAdminUserInput) error {
	panic(fmt.Errorf("not implemented: UserRoles - userRoles"))
}
