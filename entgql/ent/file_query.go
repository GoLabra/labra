...
func (_q *FileQuery) QueryAdminCreatedBy() *AdminUserQuery {
...
func (_q *FileQuery) QueryAdminUpdatedBy() *AdminUserQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *FileQuery) QueryCreatedBy() *UserQuery {
...
func (_q *FileQuery) QueryUpdatedBy() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *FileQuery) WithAdminCreatedBy(opts ...func(*AdminUserQuery)) *FileQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
...
func (_q *FileQuery) WithAdminUpdatedBy(opts ...func(*AdminUserQuery)) *FileQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *FileQuery) WithCreatedBy(opts ...func(*UserQuery)) *FileQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *FileQuery) WithUpdatedBy(opts ...func(*UserQuery)) *FileQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *FileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*File, error) {
	...
	if _q.withAdminCreatedBy != nil || _q.withAdminUpdatedBy != nil || _q.withCreatedBy != nil || _q.withUpdatedBy != nil {
		withFKs = true
	}
	if withFKs {
...
func (_q *FileQuery) loadAdminCreatedBy(ctx context.Context, query *AdminUserQuery, nodes []*File, init func(*File), assign func(*File, *AdminUser)) error {
...
func (_q *FileQuery) loadAdminUpdatedBy(ctx context.Context, query *AdminUserQuery, nodes []*File, init func(*File), assign func(*File, *AdminUser)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*File)
	for i := range nodes {
...
func (_q *FileQuery) loadCreatedBy(ctx context.Context, query *UserQuery, nodes []*File, init func(*File), assign func(*File, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*File)
	for i := range nodes {
...
func (_q *FileQuery) loadUpdatedBy(ctx context.Context, query *UserQuery, nodes []*File, init func(*File), assign func(*File, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*File)
	for i := range nodes {
		if nodes[i].file_updated_by == nil {
			continue
		}
		fk := *nodes[i].file_updated_by
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "file_updated_by" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
