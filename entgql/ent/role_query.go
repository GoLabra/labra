...
type RoleQuery struct {
	...
	withAdminUserRoles      *AdminUserQuery
	withUserRoles           *UserQuery
	withPermissions         *PermissionQuery
	withFKs                 bool
	modifiers               []func(*sql.Selector)
	loadTotal               []func(context.Context, []*Role) error
	withNamedAdminUserRoles map[string]*AdminUserQuery
...
func (_q *RoleQuery) QueryAdminCreatedBy() *AdminUserQuery {
...
func (_q *RoleQuery) QueryAdminUpdatedBy() *AdminUserQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *RoleQuery) QueryAdminUserRoles() *AdminUserQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *RoleQuery) QueryUserRoles() *UserQuery {
...
func (_q *RoleQuery) Clone() *RoleQuery {
	...
	return &RoleQuery{
		...
		withAdminUserRoles: _q.withAdminUserRoles.Clone(),
...
func (_q *RoleQuery) WithAdminCreatedBy(opts ...func(*AdminUserQuery)) *RoleQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
...
func (_q *RoleQuery) WithAdminUpdatedBy(opts ...func(*AdminUserQuery)) *RoleQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithAdminUserRoles tells the query-builder to eager-load the nodes that are connected to
// the "admin_user_roles" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *RoleQuery) WithAdminUserRoles(opts ...func(*AdminUserQuery)) *RoleQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAdminUserRoles = query
	return _q
}
...
func (_q *RoleQuery) WithUserRoles(opts ...func(*UserQuery)) *RoleQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	var (
		...
		loadedTypes = [5]bool{
			...
			_q.withAdminUserRoles != nil,
			_q.withUserRoles != nil,
			_q.withPermissions != nil,
		}
	)
	if _q.withAdminCreatedBy != nil || _q.withAdminUpdatedBy != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := _q.withAdminUserRoles; query != nil {
		if err := _q.loadAdminUserRoles(ctx, query, nodes,
			func(n *Role) { n.Edges.AdminUserRoles = []*AdminUser{} },
			func(n *Role, e *AdminUser) { n.Edges.AdminUserRoles = append(n.Edges.AdminUserRoles, e) }); err != nil {
			return nil, err
		}
	}
	...
	for name, query := range _q.withNamedAdminUserRoles {
		if err := _q.loadAdminUserRoles(ctx, query, nodes,
			func(n *Role) { n.appendNamedAdminUserRoles(name) },
			func(n *Role, e *AdminUser) { n.appendNamedAdminUserRoles(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *RoleQuery) loadAdminCreatedBy(ctx context.Context, query *AdminUserQuery, nodes []*Role, init func(*Role), assign func(*Role, *AdminUser)) error {
...
func (_q *RoleQuery) loadAdminUpdatedBy(ctx context.Context, query *AdminUserQuery, nodes []*Role, init func(*Role), assign func(*Role, *AdminUser)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Role)
	for i := range nodes {
...
func (_q *RoleQuery) loadAdminUserRoles(ctx context.Context, query *AdminUserQuery, nodes []*Role, init func(*Role), assign func(*Role, *AdminUser)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(role.AdminUserRolesTable)
		s.Join(joinT).On(s.C(adminuser.FieldID), joinT.C(role.AdminUserRolesPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(role.AdminUserRolesPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(role.AdminUserRolesPrimaryKey[1]))
	...
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "admin_user_roles" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (_q *RoleQuery) loadUserRoles(ctx context.Context, query *UserQuery, nodes []*Role, init func(*Role), assign func(*Role, *User)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[string]*Role)
	nids := make(map[string]map[*Role]struct{})
	for i, node := range nodes {
...
// WithNamedAdminUserRoles tells the query-builder to eager-load the nodes that are connected to the "admin_user_roles"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *RoleQuery) WithNamedAdminUserRoles(name string, opts ...func(*AdminUserQuery)) *RoleQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedAdminUserRoles == nil {
		_q.withNamedAdminUserRoles = make(map[string]*AdminUserQuery)
	}
	_q.withNamedAdminUserRoles[name] = query
	return _q
}

// WithNamedUserRoles tells the query-builder to eager-load the nodes that are connected to the "user_roles"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *RoleQuery) WithNamedUserRoles(name string, opts ...func(*UserQuery)) *RoleQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedUserRoles == nil {
		_q.withNamedUserRoles = make(map[string]*UserQuery)
	}
