...
func (_q *UserQuery) QueryRefCreatedBy() *UserQuery {
...
func (_q *UserQuery) QueryCreatedBy() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *UserQuery) QueryRefUpdatedBy() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *UserQuery) QueryUpdatedBy() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *UserQuery) QueryAdminCreatedBy() *AdminUserQuery {
...
func (_q *UserQuery) QueryAdminUpdatedBy() *AdminUserQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *UserQuery) QueryDefaultRole() *RoleQuery {
	query := (&RoleClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withRefCreatedBy:   _q.withRefCreatedBy.Clone(),
		withCreatedBy:      _q.withCreatedBy.Clone(),
		withRefUpdatedBy:   _q.withRefUpdatedBy.Clone(),
...
// WithRefCreatedBy tells the query-builder to eager-load the nodes that are connected to
// the "ref_created_by" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithRefCreatedBy(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withRefCreatedBy = query
	return _q
}

// WithCreatedBy tells the query-builder to eager-load the nodes that are connected to
// the "created_by" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithCreatedBy(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithRefUpdatedBy tells the query-builder to eager-load the nodes that are connected to
// the "ref_updated_by" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithRefUpdatedBy(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withRefUpdatedBy = query
	return _q
}

// WithUpdatedBy tells the query-builder to eager-load the nodes that are connected to
// the "updated_by" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithUpdatedBy(opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithAdminCreatedBy(opts ...func(*AdminUserQuery)) *UserQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithAdminUpdatedBy(opts ...func(*AdminUserQuery)) *UserQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithDefaultRole(opts ...func(*RoleQuery)) *UserQuery {
	query := (&RoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withRefCreatedBy; query != nil {
		if err := _q.loadRefCreatedBy(ctx, query, nodes,
			func(n *User) { n.Edges.RefCreatedBy = []*User{} },
			func(n *User, e *User) { n.Edges.RefCreatedBy = append(n.Edges.RefCreatedBy, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withRefUpdatedBy; query != nil {
		if err := _q.loadRefUpdatedBy(ctx, query, nodes,
			func(n *User) { n.Edges.RefUpdatedBy = []*User{} },
			func(n *User, e *User) { n.Edges.RefUpdatedBy = append(n.Edges.RefUpdatedBy, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withDefaultRole; query != nil {
		if err := _q.loadDefaultRole(ctx, query, nodes, nil,
			func(n *User, e *Role) { n.Edges.DefaultRole = e }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedRefCreatedBy {
		if err := _q.loadRefCreatedBy(ctx, query, nodes,
			...
			func(n *User, e *User) { n.appendNamedRefCreatedBy(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedRefUpdatedBy {
		if err := _q.loadRefUpdatedBy(ctx, query, nodes,
			func(n *User) { n.appendNamedRefUpdatedBy(name) },
			func(n *User, e *User) { n.appendNamedRefUpdatedBy(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *UserQuery) loadRefCreatedBy(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	...
	query.Where(predicate.User(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RefCreatedByColumn), fks...))
	}))
...
func (_q *UserQuery) loadCreatedBy(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
...
func (_q *UserQuery) loadRefUpdatedBy(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.User(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RefUpdatedByColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadUpdatedBy(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*User)
	for i := range nodes {
...
func (_q *UserQuery) loadAdminCreatedBy(ctx context.Context, query *AdminUserQuery, nodes []*User, init func(*User), assign func(*User, *AdminUser)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*User)
	for i := range nodes {
...
func (_q *UserQuery) loadAdminUpdatedBy(ctx context.Context, query *AdminUserQuery, nodes []*User, init func(*User), assign func(*User, *AdminUser)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*User)
	for i := range nodes {
...
func (_q *UserQuery) loadDefaultRole(ctx context.Context, query *RoleQuery, nodes []*User, init func(*User), assign func(*User, *Role)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*User)
	for i := range nodes {
		if nodes[i].user_default_role == nil {
			continue
		}
		fk := *nodes[i].user_default_role
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "user_default_role" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
// WithNamedRefCreatedBy tells the query-builder to eager-load the nodes that are connected to the "ref_created_by"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedRefCreatedBy(name string, opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedRefCreatedBy == nil {
		_q.withNamedRefCreatedBy = make(map[string]*UserQuery)
	}
	_q.withNamedRefCreatedBy[name] = query
	return _q
}

// WithNamedRefUpdatedBy tells the query-builder to eager-load the nodes that are connected to the "ref_updated_by"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithNamedRefUpdatedBy(name string, opts ...func(*UserQuery)) *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedRefUpdatedBy == nil {
		_q.withNamedRefUpdatedBy = make(map[string]*UserQuery)
	}
	_q.withNamedRefUpdatedBy[name] = query
	return _q
}
