...
// ForPermission is the model entity for the ForPermission schema.
type ForPermission struct {
	...
	// IsStupid holds the value of the "is_stupid" field.
	IsStupid *bool `json:"is_stupid,omitempty"`
	// Edges holds the relations/edges for other nodes in the graph.
	// The values are being populated by the ForPermissionQuery when eager-loading is set.
	Edges                           ForPermissionEdges `json:"edges"`
	for_permission_created_by       *string
	for_permission_updated_by       *string
	for_permission_admin_created_by *string
	for_permission_admin_updated_by *string
	selectValues                    sql.SelectValues
}

// ForPermissionEdges holds the relations/edges for other nodes in the graph.
type ForPermissionEdges struct {
...
func (e ForPermissionEdges) CreatedByOrErr() (*User, error) {
	if e.CreatedBy != nil {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ForPermissionEdges) UpdatedByOrErr() (*User, error) {
	if e.UpdatedBy != nil {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ForPermissionEdges) AdminCreatedByOrErr() (*AdminUser, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ForPermissionEdges) AdminUpdatedByOrErr() (*AdminUser, error) {
...
func (*ForPermission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case forpermission.FieldID, forpermission.FieldName:
			values[i] = new(sql.NullString)
		case forpermission.FieldCreatedAt, forpermission.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case forpermission.ForeignKeys[0]: // for_permission_created_by
			values[i] = new(sql.NullString)
		case forpermission.ForeignKeys[1]: // for_permission_updated_by
			values[i] = new(sql.NullString)
		case forpermission.ForeignKeys[2]: // for_permission_admin_created_by
			values[i] = new(sql.NullString)
		case forpermission.ForeignKeys[3]: // for_permission_admin_updated_by
			values[i] = new(sql.NullString)
		default:
...
// ForPermissions is a parsable slice of ForPermission.
type ForPermissions []*ForPermission
