...
const (
	// Label holds the string label denoting the lifecyclenot type in the database.
	Label = "life_cycle_not"
	...
	// Table holds the table name of the lifecyclenot in the database.
	Table = "life_cycle_nots"
	// CreatedByTable is the table that holds the created_by relation/edge.
	CreatedByTable = "life_cycle_nots"
	// CreatedByInverseTable is the table name for the User entity.
	// It exists in this package in order to avoid circular dependency with the "user" package.
	CreatedByInverseTable = "users"
	// CreatedByColumn is the table column denoting the created_by relation/edge.
	CreatedByColumn = "life_cycle_not_created_by"
	// UpdatedByTable is the table that holds the updated_by relation/edge.
	UpdatedByTable = "life_cycle_nots"
	...
	AdminCreatedByColumn = "life_cycle_not_admin_created_by"
	// AdminUpdatedByTable is the table that holds the admin_updated_by relation/edge.
	AdminUpdatedByTable = "life_cycle_nots"
	...
	AdminUpdatedByColumn = "life_cycle_not_admin_updated_by"
)

// Columns holds all SQL columns for lifecyclenot fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "life_cycle_nots"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"life_cycle_not_created_by",
	"life_cycle_not_updated_by",
	"life_cycle_not_admin_created_by",
	"life_cycle_not_admin_updated_by",
}
...
func EntityStateValidator(es entity.EntityState) error {
	...
	case "DRAFT", "ARCHIVED", "PUBLISHED":
		return nil
	default:
		return fmt.Errorf("lifecyclenot: invalid enum value for entity_state field: %q", es)
	}
}

// OrderOption defines the ordering options for the LifeCycleNot queries.
