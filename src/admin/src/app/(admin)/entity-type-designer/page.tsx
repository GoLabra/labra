            ...
            <Stack spacing={2}>
              <Stack alignItems="center" direction="row" spacing={3}>
                ...
                <div>
                  ...
                  <Typography color="text.secondary" variant="body2">
                    Start by creating a new entity. Click on the &apos;Add
                    Entity&apos; button to begin.
                  </Typography>
                </div>
              </Stack>
              ...
              <Stack alignItems="center" direction="row" spacing={3}>
                ...
                <div>
                  ...
                  <Typography color="text.secondary" variant="body2">
                    If you have existing entities, you can select one from the
                    sidebar to view and edit its details.
                  </Typography>
                </div>
              </Stack>
            </Stack>
