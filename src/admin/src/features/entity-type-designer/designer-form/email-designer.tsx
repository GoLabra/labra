...
export const schema = z.object({
    ...
    unique: z.preprocess((value) => !!value, z.coerce.boolean().optional()),
    defaultValue: z.literal("").transform(() => null).or(z.string().email('Invalid email')).nullable()
});
...
export const DesignerForm = (props: DesignerFormProps) => {
    ...
    return (<Stack gap={1.5}>
        ...
        <Stack direction="row" gap={1}>
            ...
            <BooleanFormField name="unique" label="Unique" disabled={!!props.formMethods.watch('defaultValue')} />
        </Stack>
        <TextShortFormField name="defaultValue" label="Default Value" disabled={props.formMethods.watch('unique') === true} />
    </Stack>
    )
}
