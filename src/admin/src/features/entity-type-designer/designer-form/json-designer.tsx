...
import { isJsonOrNull } from "@/lib/utils/is-json";
...
export const schema = z.object({
    ...
    defaultValue: z.string().transform(i => i?.trim() || undefined).optional().nullish().refine((val) => isJsonOrNull(val), { message: "Invalid JSON", })
});
...
export const DesignerForm = (props: DesignerFormProps) => {
    ...
    return (<Stack gap={1.5}>
        ...
        <JSONFormField name="defaultValue" label="Default Value" disabled={props.formMethods.watch('unique') === true} />
    </Stack>
    )
}
