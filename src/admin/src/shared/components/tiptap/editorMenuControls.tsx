    ...
    return (
      ...
      clutter. */}
            ...
            <MenuButtonImageUpload
                ...
                onUploadFiles={(files) => getInlineFiles(files)}
...
export function getInlineFiles(files: File[]): Promise<ImageNodeAttributes[]> {

    const promises = files.map((file) => {
        return new Promise<ImageNodeAttributes>((resolve, reject) => {
