...
input RoleWhereInput {
  ...
  hasUserRolesWith: [AdminUserWhereInput!]
  """
...
func (ec *executionContext) unmarshalInputCreateRoleInput(ctx context.Context, obj any) (ent.CreateRoleInput, error) {
	...
	fieldsInOrder := [...]string{"name", "userRoleIDs", "permissionIDs", "adminCreatedBy", "adminUpdatedBy", "userRoles", "permissions"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRoleWhereInput(ctx context.Context, obj any) (ent.RoleWhereInput, error) {
	...
	fieldsInOrder := [...]string{"not", "and", "or", "id", "idNEQ", "idIn", "idNotIn", "idGT", "idGTE", "idLT", "idLTE", "idEqualFold", "idContainsFold", "name", "nameNEQ", "nameIn", "nameNotIn", "nameGT", "nameGTE", "nameLT", "nameLTE", "nameContains", "nameHasPrefix", "nameHasSuffix", "nameEqualFold", "nameContainsFold", "createdAt", "createdAtNEQ", "createdAtIn", "createdAtNotIn", "createdAtGT", "createdAtGTE", "createdAtLT", "createdAtLTE", "createdAtIsNil", "createdAtNotNil", "updatedAt", "updatedAtNEQ", "updatedAtIn", "updatedAtNotIn", "updatedAtGT", "updatedAtGTE", "updatedAtLT", "updatedAtLTE", "updatedAtIsNil", "updatedAtNotNil", "hasAdminCreatedBy", "hasAdminCreatedByWith", "hasAdminUpdatedBy", "hasAdminUpdatedByWith", "hasUserRoles", "hasUserRolesWith", "hasPermissions", "hasPermissionsWith"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateRoleInput(ctx context.Context, obj any) (ent.UpdateRoleInput, error) {
	...
	fieldsInOrder := [...]string{"name", "addUserRoleIDs", "removeUserRoleIDs", "clearUserRoles", "addPermissionIDs", "removePermissionIDs", "clearPermissions", "adminCreatedBy", "adminUpdatedBy", "userRoles", "permissions"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
